# modified models.py
# original version:https://github.com/WongKinYiu/PyTorch_YOLOv4/blob/master/models/models.py
# reference:https://github.com/Xilinx/Vitis-AI-Copyleft-Model-Zoo/tree/main/yolov4_csp
    ...
    for i, mdef in enumerate(module_defs):
        ...
        if mdef["type"] == "convolutional":
            ...
            if (
                ...
                modules.add_module(
                    "activation", nn.LeakyReLU(negative_slope=26.0 / 256)
                )
...
class YOLOLayer(nn.Module):
    ...
    def post_process(self, p):
        ...
        # return p
        # 20231023 15:45
        # according to readme, PTQ needs to exclude all heads' post processes
...
class Darknet(nn.Module):
    ...
    def __init__(self, cfg, img_size=(416, 416), verbose=False):
        ...
        self.module_list, self.routs, self.yololayer_num = create_modules(
        ...
        self.stride = torch.tensor(
            [256 / x.shape[-2] for x in self.forward(torch.zeros(1, 3, 256, 256))]
        )  # forward
